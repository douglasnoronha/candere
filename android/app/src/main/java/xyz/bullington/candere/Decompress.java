...
public class Decompress {
    ...
    public Decompress(Context context, File zipFile, String root) {
        _zipFile = zipFile;
        this.context = context;
        this.root = root;

        _dirChecker(this.root);
    }

    public Decompress(Context context, InputStream zipFile, String root) {
